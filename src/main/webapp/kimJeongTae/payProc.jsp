...
<jsp:useBean id="mgr" class="kimJeongTae.PayMgr"></jsp:useBean>
    <%
		...
		String phone = (String)user.getPhontnum();
		String address = (String)user.getStreetaddr();
...
<body>
<script>
	//mgr로 상품 구매 가능한 유저인지 확인한뒤에 이후 로직을 처리한다
    ...
    $(function(){
        ...
        IMP.request_pay({
            ...
            if (rsp.success ) {
                ...
                //성공시 이동할 페이지
               location.href='<%=request.getContextPath()%>/kimJeongTae/paymentProc.jsp?apply_num='+rsp.apply_num+'&paid_amount='+rsp.paid_amount;
            } else {
                msg = '결제에 실패하였습니다.';
