...
<div class="row">
  ...
  <input class="category-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
  <label class="category-check-label" for="flexSwitchCheckDefault">pt</label>
</div>
<div class="category-check form-switch">
  <input class="category-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked">
  <label class="category-check-label" for="flexSwitchCheckChecked">gpt</label>
</div>
<div class="category-check form-switch">
...
<input type="text" class="col" id="content1-Lcontent" name="lcontent" value="수업번호" aria-label="Recipient's username" aria-describedby="basic-addon2" style="pointer-events: none;">
  ...
  <input class="time-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" value="09:00:00">
  <label class="time-check-label" for="flexSwitchCheckDefault" id="time-label-9">09:00:00</label>
</div>
<div class="time-check time-switch">
  <input class="time-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" value="10:00:00">
  <label class="time-check-label" for="flexSwitchCheckChecked">10:00:00</label>
</div>
<div class="time-check time-switch">
  <input class="time-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" value="11:00:00">
  <label class="time-check-label" for="flexSwitchCheckChecked">11:00:00</label>
</div>
<div class="time-check time-switch">
  <input class="time-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" value="12:00:00">
  <label class="time-check-label" for="flexSwitchCheckChecked">12:00:00</label>
</div>
<div class="time-check time-switch">
  <input class="time-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" value="13:00:00">
  <label class="time-check-label" for="flexSwitchCheckChecked">13:00:00</label>
</div>
<div class="time-check time-switch">
  <input class="time-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" value="14:00:00">
  <label class="time-check-label" for="flexSwitchCheckChecked">14:00:00</label>
</div>
<div class="time-check time-switch">
  <input class="time-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" value="15:00:00">
  <label class="time-check-label" for="flexSwitchCheckChecked">15:00:00</label>
</div>
<div class="time-check time-switch">
  <input class="time-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" value="16:00:00">
  <label class="time-check-label" for="flexSwitchCheckChecked">16:00:00</label>
</div>
<div class="time-check time-switch">
