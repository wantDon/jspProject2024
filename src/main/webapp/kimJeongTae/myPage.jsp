...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      events: [
        //db에서 트레이너 정보를 받아서 출력해준다. 강사 이름 시작시간,끝나는 시간
        //현재시간 기준으로 한달전후로 스케줄을 띄워줄려고 한다.
    	    {
              title: 'All Day Event',
              start: '2024-01-01'
            },
...
<script>
    function openMiniWindow() {
      // 미니 창 열기
      var newWindow = window.open('mini_window.html', '', 'width=400,height=200');
    }

    // 미니 창으로부터 입력 받기
    function receiveDataFromMiniWindow(data) {
      document.getElementById('vectorData').innerText = data;
    }
</script>
<!--구매내역-->
<script>
            ...
            <div id="layoutSidenav_content">
                <main>       
                    ...
                    <div id="content2" class="content">
                        <!-- 예약 정보 <div id="dynamic-revation-information">정보출력예정</div>-->
                            ...
                            <div class="col border-top border-secondary border-4" style="max-width: 1000px; min-width: 100px; font-size: 24px; text-align: left; padding: 30px;">
                                ...
                                <div class="border border-1 border-secondary rounded-3" style="padding: 10px;">
                                    ...
                                    <div class="row" style="font-size: 14px;">
                                        ...
                                        <div class="col">
                                            <div>이름명(법인명) 홍길동</div>
                                            <div>전 화 번 호 010-0000-0000</div>
                                            <div>이 메 일  입력 없음</div>
                                        </div>
                                        <!--예약인원 + 차량번호 + 트레이너-->
                                        <div class="col">
                                            <div>예 약 인 원   4</div>
                                            <div>차 량 번 호    입력 없음</div>
                                            <div>트 레 이 너     김안나</div>
                                        </div>
                                    </div>
                                    <!--예약변경+예약취소 버튼-->
                                    <div style="text-align: right;">
                                        <button type="button" class="btn btn-warning" onclick="openMiniWindow()">수정</button>
                                        <button type="button" class="btn btn-light">삭제</button>
                                    </div>
                                    <p id="vectorData">여기에 백터형태 자료가 입력됩니다.</p>
                        ...
                        <div class="row d-flex justify-content-center" style="margin: 50px;">
                            <div class="col border-top border-secondary border-4" style="max-width: 1000px; min-width: 100px; font-size: 24px; text-align: left; padding: 30px;">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="123-456-789" aria-label="username" aria-describedby="basic-addon1" style="pointer-events: none;">
                                </div>
                                  
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon2">상품정보</span>
                                    <input type="text" class="form-control" placeholder="어떤상품1" aria-label="Recipient's username" aria-describedby="basic-addon2" style="pointer-events: none;">
                                    <span class="input-group-text" id="basic-addon2">이용기간</span>
                                    <input type="text" class="form-control" placeholder="죽을때까지" aria-label="Recipient's username" aria-describedby="basic-addon2" style="pointer-events: none;">
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="홍길동" aria-label="Recipient's username" aria-describedby="basic-addon2" >
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="111-222-3333" aria-label="Recipient's username" aria-describedby="basic-addon2" >
                                        <span class="input-group-text" id="basic-addon2">이메일</span>
                                        <input type="text" class="form-control" placeholder="bbb@gmail.com" aria-label="Recipient's username" aria-describedby="basic-addon2" >
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon2">아이디</span>
                                        <input type="text" class="form-control" placeholder="aaa123" aria-label="Recipient's username" aria-describedby="basic-addon2" style="pointer-events: none;">
                                        <span class="input-group-text" id="basic-addon2">비밀번호</span>
                                        <input type="text" class="form-control" placeholder="1234" aria-label="Recipient's username" aria-describedby="basic-addon2" >
                                    </div>
                                </div>
                                  <!--주소 입력-->
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon2">주소</span>
                                        <input type="text" class="form-control" placeholder="대한민국 어딘가" aria-label="Recipient's username" aria-describedby="basic-addon2" style="pointer-events: none;">
                                        <button style="font-size: 14px;" onclick="showAlert01()">우편번호 찾기</button>
                                        <script>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="삼성전자고객센터" aria-label="Recipient's username" aria-describedby="basic-addon2" style="pointer-events: none;">
                                    <div class="form-text" id="basic-addon4" style="font-size: 14px;">*소속변경은 직접 문의해주세요</div>
                                </div>
                                <button type="button" class="btn btn-secondary" style="margin: 10px;">변경사항 저장하기</button>
