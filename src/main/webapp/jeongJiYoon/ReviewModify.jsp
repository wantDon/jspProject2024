...
<html lang="en">
	...
	<body>
		...
		<form id="reviewForm" action="reviewUpdate" method="post"> <!-- 수정: action을 reviewUpdate 서블릿으로 변경 -->
		    <table>
		        <tbody>
		        <tr style="height: 15%;">
		            <th style="text-align: center; width: 15%;">이름</th>
		            <td><input type="text" name="name" style="width: 40%; height: 50%;" value=""></td> <!-- 수정: 리뷰의 이름을 표시할 곳 -->
		        </tr>
		        <tr style="height: 15%;">
		            <th style="text-align: center;">제목</th>
		            <td>
		                <!-- title 입력란에 ID 추가 -->
		                <input type="text" id="title" name="title" style="width: 40%; height: 50%; margin-right: 200px;" value=""> <!-- 수정: 리뷰의 제목을 표시할 곳 -->
		        ...
		        <tr>
		            ...
		            <!-- content 입력란에 ID 추가 -->
		            <td><textarea id="content" name="content"></textarea></td> <!-- 수정: 리뷰의 내용을 표시할 곳 -->
		        </tr>
		        </tbody>
		    </table>
