...
<%
			...
			String tr7 = request.getParameter("tr7");
			...
			String nextTr6 = request.getParameter("nextTr6");
		    ...
		    int nextTr66 = Integer.parseInt(nextTr6);
		    ...
		    mgr.updateTrainerInfo(usernum11, tr7, nextTr5, nextTr66);
		    isValid = true;
		    msg = "수정 완료";
