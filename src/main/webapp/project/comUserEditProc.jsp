...
<jsp:useBean id = "cbean" class ="project.CompanyBean"/>
...
<%
    ...
    String nextTr5 = request.getParameter("nextTr5");
    ...
    nextTr55 = lMgr.getCnum(nextTr5);
    
    
    if (tr1 == null || tr2 == null || tr3 == null || tr8 == null || nextTr1 == null || nextTr4 == null || nextTr5 == null || userId1 == null || groupId1 == null) {
        msg = "수정 사항을 모두 적어주세요";
        isValid = false;

    } else {
    
    mgr.updateComUser(tr1, tr22, tr3, tr88, nextTr1, nextTr44,nextTr55, userId1);
