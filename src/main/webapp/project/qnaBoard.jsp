...
<%
			...
			totalRecord = rvMgr.getTotalQna(keyField, keyWord);
					...
					<h1 class="mt-4  dongle-title">&nbsp;&nbsp;  게시판 관리</h1>
			              <hr>
								...
								<form name="searchFrm" class="search-form">
								    ...
								    <a href = "qnaBoard.jsp" class = "refresh-btn">새로 고침</a>
								    <a href = "notice.jsp" class = "b-btn">리뷰게시판 보기</a>
                       ...
                       <div class="card">
                                    ...
                                    <tbody>
     <%
													Vector<QnaBean> pvlist = rvMgr.getAllQnaList(keyField, keyWord, start, cnt);
