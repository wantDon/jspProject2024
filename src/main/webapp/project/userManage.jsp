...
<!-- 
1. 수정할때 id로 검색해서 수정하기 때문에 같은 id일 경우 데이터가 다 같이 수정됨: 가입시 id중복 막을거라 상관x
-> 대신 발표할땐 더미 데이터말고 하나 제대로 데이터 들어가 있어야함.
2. 등록 버튼 눌렀을때 연결될 jsp 아직 없음. 2024-4-9. 
-->
...
<%
		...
		totalRecord = uMgr.getTotalUser(keyField, keyWord);
	    ...
	    delButtons.forEach(function(button){
	    	button.addEventListener('click', function(){
	    		...
	    		if(isEditing === 'true'){
	    			...
	    			var form = document.getElementById('userDelForm');
...
<div id="layoutSidenav_content">
    <main>
        ...
        <h1 class="mt-4 dongle-title">&nbsp;&nbsp;등록 회원 관리</h1>
              ...
              <hr>
					...
					<form name="searchFrm" class="search-form">
					    ...
					    <a href="userJoin.jsp" class="register-button">회원 등록</a>
					    <a href = "userManage.jsp" class = "refresh-btn">새로 고침</a>
					...
					<hr>
                        ...
                        <div class="card">
          					  ...
          					  <thead>
       						     ...
       						     <tbody>
       						             <%
													Vector<UserBean> uvlist = uMgr.getUserList(keyField, keyWord, start, cnt);
...
<form id = "userEditForm" name="UserEdit" method="post" action="UserEditProc.jsp" >
...
<form id = "userDelForm" name="UserDel" method="post" action="UserDelProc.jsp" >
    <input name="usernum1"  type="hidden">
</form>
